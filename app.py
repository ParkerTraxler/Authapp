...
from models import db, User, Role, InfoChangeRequest, FERPARequest
...
def manage_requests():
    ...
    infochange_requests = InfoChangeRequest.query.all()
...
# Approve request
@app.route('/manager/requests/ferpa-approve/<int:id>', methods=['POST'])
@role_required('manager')
...
# Return request
@app.route('/manager/requests/ferpa-return/<int:id>', methods=['POST'])
@role_required('manager')
...
# Reject request
@app.route('/manager/requests/ferpa-reject/<int:id>', methods=['POST'])
@role_required('manager')
...
@app.route('/manager/requests/infochange-approve/<int:id>', methods=['POST'])
@role_required('manager')
...
@app.route('/manager/requests/infochange-return/<int:id>', methods=['POST'])
@role_required('manager')
...
# Reject info change request
@app.route('/manager/requests/infochange-reject/<int:id>', methods=['POST'])
@role_required('manager')
...
@app.route('/user/requests/edit-ferpa-request/<ferpa_request_id>', methods=['GET', 'POST'])
@role_required('user')
