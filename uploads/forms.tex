...
Parker Traxler & 123456\\
\end{tabular}

\vspace{1em}
\noindent\textbf{*What are you requesting to add or update?}\\
\begin{itemize}[leftmargin=0.7cm]
	\item \CheckedBox{yes} Update Name (Complete Section A)
...
FROM: & & TO: & \\
First name & \makebox[4cm][l]{\textbf{Parker}} \underline{\hspace{4cm}} & First name & \makebox[4cm][l]{\textbf{Parker}} \underline{\hspace{4cm}} \\
Middle name & \makebox[4cm][l]{\textbf{Dean}} \underline{\hspace{4cm}} & Middle name & \makebox[4cm][l]{\textbf{Dean}} \underline{\hspace{4cm}} \\
Last name & \makebox[4cm][l]{\textbf{Traxler}} \underline{\hspace{4cm}} & Last name & \makebox[4cm][l]{\textbf{Example}} \underline{\hspace{4cm}} \\
...
\vspace{0.5em}
\noindent FROM: 123-45-6789

\vspace{0.5em}
\noindent TO: 123-45-6789

\vspace{0.5em}
\begin{itemize}[leftmargin=0.7cm]
	\item \CheckedBox{yes} Marriage/Divorce
...
\vspace{1em}
\noindent\textbf{*SIGNATURE (REQUIRED)} \includegraphics[width=5cm]{uploads/signatures/edcb12a8-59ef-46dd-a104-a29904244769.jpg} Date 2003-09-20
